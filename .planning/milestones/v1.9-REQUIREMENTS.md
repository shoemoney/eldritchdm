# EldritchDM — Requirements Archive (v1.9 Performance Baseline + Tuning — SHIPPED)

**Milestone:** v1.9 Performance Baseline + Tuning
**Status:** ✅ Complete (2026-05-26)
**Goal:** Profile + baseline + regression-detection CLI.
**Total v1.9 requirements:** 6 — all satisfied (TUNE-01 Branch B closure).
