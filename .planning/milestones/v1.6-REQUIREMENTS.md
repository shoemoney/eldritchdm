# EldritchDM — Requirements Archive (v1.6 UX/Feature Expansion — SHIPPED)

**Milestone:** v1.6 UX/Feature Expansion
**Status:** ✅ Complete (2026-05-25)
**Goal:** Close deferred UX + feature items — streaming embed, AOE tactic, monster memory, operator polish.
**Total v1.6 requirements:** 12 — all satisfied (2 v1.7 doc/wiring follow-ups documented in audit).
