# EldritchDM — Requirements Archive (v1.7 Integration & Polish — SHIPPED)

**Milestone:** v1.7 Integration & Polish
**Status:** ✅ Complete (2026-05-25, WIRE-01 deferred — dm20 event-surface gap)
**Goal:** Close v1.6 honest-gaps + CI matrix + bundled dashboards + doc-fixes.
**Total v1.7 requirements:** 6 — 5 satisfied, 1 deferred with full disclosure.
